const hideTag = (wrapper) => wrapper.style.display = "none";

class AdLinkDelivery {
    async getTags() {
...
const adLinkDelivery = new AdLinkDelivery();
adLinkDelivery.getTags().then(res => console.log('res', res));
