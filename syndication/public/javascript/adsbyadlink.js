let delivery = {
    ...
    processTag: function (id, creatives, tag) {
    ...
    noSafeFrameWithContent: function (wrapper, content) {
    ...
    createIframe: function (wrapper, iframeId) {
    ...
    hideTag: function (wrapper) {
        wrapper.style.display = "none";
    },
    minMaxSize: function (sizes) {
    ...
    cacheCreatives: async function(adUnitCode, sizes) {
    ...
    serviceResponse: async function (adUnitCode, sizes) {
        try {
    ...
    getCreatives: async function (adUnitCode, sizes) {
    ...
    getCreative: function (creatives, key) {
